...
class QueryCompletedEventConverter {
    ...
    static QueryCompletedEventV1 convert(QueryCompletedEvent queryCompletedEvent) {
        ...
        QueryCompletedEventV1.Builder queryCompleted = QueryCompletedEventV1.newBuilder()
                ...
                .setPrinciple(queryCompletedEvent.getContext().getPrincipal().toString())
                .setUserAgent(queryCompletedEvent.getContext().getUserAgent().toString())
                .setRemoteClientAddress(queryCompletedEvent.getContext().getRemoteClientAddress().toString())
                .setClientInfo(queryCompletedEvent.getContext().getClientInfo().toString())
